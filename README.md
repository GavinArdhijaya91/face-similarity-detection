...
├── streamlit_app/        # Aplikasi UI interaktif (Streamlit)
├── fastapi_app/          # Backend REST API (FastAPI + Vercel)
├── api/                  # Vercel serverless wrapper
├── scripts/              # Script utilitas: dataset, tuning, evaluasi
└── docs/                 # Dokumentasi konsep dan aset visual
    └── assets/           # Gambar output PCA (eigenfaces, variance, dll)
```
